...
- `awaiting`: user
- `handoff-note`: Codex cleaned the remaining repository noise after the prerelease follow-up commit: removed the tracked root `.DS_Store`, deleted the untracked `.agents/.DS_Store`, and removed the obsolete `.agents/reviews/2026-04-22-kimi-prerelease-review.md` file. No plugin code changed in this turn.
