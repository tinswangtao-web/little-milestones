...
- `awaiting`: user
- `handoff-note`: `.agents/reviews/2026-04-22-kimi-mobile-ux-review.md` is now tracked in git, so the current mobile review baseline is preserved in the repository for future fixes and re-reviews.
