...
- `awaiting`: codex
- `handoff-note`: Codex is tracking `.agents/reviews/2026-04-22-kimi-mobile-ux-review.md` in git so the current mobile review baseline is preserved in the repository instead of remaining untracked local context.
