...
3. Search for "Little Milestones"
...
1. **Open the Plugin**: Click the 🌱 icon in the ribbon or use the command "Open Little Milestones"
2. **Configure Settings**: Go to plugin settings to customize:
   - Scoring categories and items
   - Diary modules and fields
   - Goals and targets
   - Report templates
3. **Start Tracking**: Use the daily modal to record behavior, write diary entries, and track activities
4. **View Reports**: Generate reports to see progress and patterns over time
...
### Keyboard Shortcuts
- `Ctrl/Cmd + M`: Open the daily scoring modal
...
Made with ❤️ for parents and kids tracking growth together.
